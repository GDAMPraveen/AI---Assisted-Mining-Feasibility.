...
if page == "Single Site Input":
    ...
    with st.form("mining_form"):
        data = {
            ...
            "Land_Use_Type": st.selectbox("Land Use Type",
                ["Forest", "Agriculture", "Urban", "Mining"]),
            "Mining_Employment_Dependency_%": st.slider(
                "Mining Employment Dependency (%)", 0, 100, 20),
            ...
            "Road_Connectivity": st.selectbox(
                "Road Connectivity", ["Poor", "Moderate", "Good"]),
...
# =====================================================
    ...
    if file:
        ...
        df["Mining_Allowed_Prediction"] = [
            "Yes" if p == 1 else "No" for p in preds
        ]
        ...
        if st.button("Run Prediction"):
            ...
            if groq_client and use_ai:
                ...
                with st.spinner("Analyzing..."):
                    explanation = groq_explanation(df, pred)
